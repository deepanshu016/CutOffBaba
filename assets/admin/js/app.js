! function() {
    ...
    var  u = 7;
    var  g = "en";
    var  b = localStorage.getItem("language");
    ...
    }), sessionStorage.setItem("defaultAttribute", JSON.stringify(a)), q(a), (i = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && i.click()), f(), t = document.getElementById("search-close-options"), o = document.getElementById("search-dropdown"), (n = document.getElementById("search-options")) && (n.addEventListener("focus", function() {
