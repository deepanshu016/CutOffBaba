      ...
      <main>
         <div class="position-relative overflow-hidden p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 p-3 mx-auto ">
               <h4 class="text-start y6Cfh"> <img src="img/rightarrow.png"> </h4>
               <a class="float-end" href="#!"><img class="userCanv" src="img/usera.png" alt=""></a>
            </div>
         </div>
               ...
               <div class="row">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="card text-bg-dark ">
                           ...
                           <div class="swiper-wrapper d-flex align-items-center text-center">
                              <div class="swiper-slide ">
                                 <div class="card text-bg-dark wi90ks">
                                    <img src="img/bw.png" class="card-img" alt="...">
                                    <div class="card-img-overlay ">
                                       <h5 class="card-title aii5s">AIEEE COUNSELLING START FRO...</h5>
                                       <p class="card-text"><small>07 Feb 2024</small>  <span class="floatr">7 min read</span>  </p>
                                    </div>
                                 </div>
                              </div>
                              <div class="swiper-slide ">
                     ...
                     <div class="dibcsr">
                        <h4> <img src="img/vvs.png" alt="">  Hot Topic Of The Day  <span class="flsyyu">View All</span>  </h4>
                        <div class="divcouns">
                           <div class="row">
                              <div class="col-8">
                                 <span class="spanCouns">COUNSELLING</span>
                                 <h3 class="f14ps">GATE 2024 Life Sciences (XL) Paper Ana</h3>
                                 <p>GATE 2024 Life Science Paper Analysis will be updated here soon after the conclusion of the GATE examination. GA</p>
                              </div>
                              <div class="col-4">
                                 <img class="vImsh" src="img/njf.png" alt="">
                              </div>
                           </div>
                           <div class="row">
                              <div class="buyt6s">
