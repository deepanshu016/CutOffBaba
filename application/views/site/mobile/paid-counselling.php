   ...
   <body class="snnxbgs">
      <main>
         <div class="position-relative overflow-hidden p-md-5 m-md-3 text-center bg-light">
            <div class="row">
               <div class="col-2">
                  <img class="uyesrs" src="img/rightarrow.png">
               </div>
               <div class="col-7">
                  <h4 class=" fw-bold text-start cfCols">  Paid Counselling</h4>
               </div>
               <div class="col-2">
                  <img src="img/uyesr.png" alt="">
               </div>
            </div>
         </div>
         </div>
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-between">
                                       <div>
                                          ...
                                          <div class="text-center usitxt">
                                             <h1 class="text-white">₹ 119.00  <span class="srups">132.00</span></h1>
                                          </div>
                                          <!-- <ul>
                                             <li> sdjhj</li>
                                             <li> sdjhj</li>
