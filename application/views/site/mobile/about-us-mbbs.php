      ...
      <main>
         <div class="position-relative overflow-hidden   p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 p-3 mx-auto ">
               <h4 class=" fw-bold text-start txtColor"> <img src="img/rightarrow.png"> &nbsp;  Know about MBBS</h4>
               <div class="card radius">
                  <img src="img/imags.png" class="card-img cuysss " alt="doc-pic">
                              ...
                              <div class="row justify-content-center">
                                 <div class="col-12 col-lg-8 col-xl-6 text-center">
                                    <div class="lc-block mb-2">
                                       <img class="img-fluid" alt="Photo by Sebastian Pichler" src="img/Rectangless27.png">
                                    </div>
                                          ...
                                          <h5 class="fonSix">AIIMS Patna, Bihar, India</h5> 
                                            ...
                                            <ol class="list-group list-group-numbered">
                                              <li class=" d-flex justify-content-between align-items-start">
                                                <div class=" me-auto">
                                                  <div class="fw-bold"><img src="img/calender.png" alt=""> 1998</div> 
                                                </div> 
                                                <div class=" me-auto">
            ...
            <!--  <div class=" pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
               <div class="card shaDo">
                  <nav class="card" aria-label="breadcrumb">
                    <ol class="breadcrumb"> 
                      <li class="breadcrumb-item"><a href="#"> MBBS stream</a></li>
                      <li class="breadcrumb-item active" aria-current="page">about MBBS</li>
                      <li class="breadcrumb-item active" aria-current="page">state wise college</li>
                    </ol>
                  </nav>
               </div>
               </div> -->
               ...
               <div class="row ">
                  <div class="col col-md-2 col-sm-2 lesCols">
                     <div class="card card-body">
                        <img src="img/gujarat.png" class="card-img-top" alt="...">
