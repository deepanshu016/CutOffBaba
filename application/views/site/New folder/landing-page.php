            ...
            <div class="container">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12">
                     ...
                     <h4 class="text-center">Select your Choice</h4>
                           ...
                           <div class="col-md-8 col">
                              ...
                              <div class="nopadSty">
                                 ...
                                 <div class="lfeCuy">
                                    ...
                                    <a class="text-dark text-decoration-none cTacss" href="<?= base_url('course-for-stream').'/'.$stream['id']; ?>">View All Courses  <img src="<?=base_url('assets/site/img/CaretRight.png')?>"> </a>
