...
<div class="pie animate round" style="--p:<?=$correct>0?10*100/$correct:0;?>;--c:orange;background-image: conic-gradient(green <?=$correct>0?($correct*100/10)*3.6:0;?>deg,yellow 0 <?=((10-$correct-$noattempt)*100/10)*3.6;?>deg,  
                red 0);"> <?=$correct*100/10;?>%</div>
                <div class="d-flex justify-content-between">
		        <span class="badge bg-primary m-2">Total Question : 10</span>
		        <span class="badge bg-warning m-2">Total Attempted : <?=$noattempt;?></span>
