      ...
      <main>
         <div class="position-relative overflow-hidden   p-md-5 m-md-3 text-center bg-light">
            ...
            <div class="col-md-5 p-lg-5 p-3 mx-auto ">
               <h4 class=" fw-bold text-start txtColor"> <img src="<?=base_url('assets/frontend/img/rightarrow.png')?>"> &nbsp;  Know about MBBS</h4>
               <div class="card radius">
                  <img src="<?=base_url('assets/frontend/img/imags.png')?>" class="card-img cuysss " alt="doc-pic">
                ...
                <div class="row ">
                   <div class="col col-md-2 col-sm-2 lesCols">
                      <div class="card card-body">
                       <img src="<?=base_url('assets/frontend/img/gujarat.png')?>" class="card-img-top" alt="...">
