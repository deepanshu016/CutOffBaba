                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    ...
                                    <ul style="color:red;margin-left: 15px;">
                                        ...
                                        <li>Please check data in specific section there is dynamic required in excel </li>
                                        <li>Please add course id in  comma separared for fields course_accepting</li>
                                    </ul>
