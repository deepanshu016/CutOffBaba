                       ...
                       <div class="row g-4">
                          <div class="col-sm-auto">
                             <div>
                                 ...
                                 <a href="<?= base_url('admin/import-course'); ?>" class="btn btn-primary add-btn" ><i class="ri-upload-2-line"></i> Import </a>
                                 <a href="<?= base_url('admin/export-course'); ?>" class="btn btn-primary add-btn" ><i class="ri-download-2-line"></i> Export </a>
                              </div>
                          </div>
                       </div>
