                                ...
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            ...
                                            <a href="<?= base_url('assets/uploads/excels/specialSubCategoryImport.xlsx'); ?>" class="btn btn-success add-btn" download="specialSubCategoryImport"><i class="ri-download-2-line"></i> View Sample</a>
                                        </div>
                                    </div>
