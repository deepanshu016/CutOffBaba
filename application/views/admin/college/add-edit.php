                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" placeholder="College Full Name" name="full_name">
                                              <input type="hidden" class="form-control" name="college_id" value="<?= (!empty($singleCollege)) ? $singleCollege['id'] : ''; ?>">
                                              <input type="hidden" class="form-control" name="old_media" value="<?= (!empty($singleCollege)) ? $singleCollege['media'] : ''; ?>">
                                      ...
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              ...
                                              <textarea name="short_description" class="form-control" placeholder="Short Description" rows="5" cols="15"></textarea>
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" placeholder="College Popular Name 1" name="popular_name_one">
                                          </div>
                                      </div>
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              <label for="basiInput" class="form-label">College Popular Name 2</label>
                                              <input type="text" class="form-control" placeholder="College Popular Name 2" name="popular_name_two">
                                          </div>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              ...
                                              <input type="date" class="form-control" placeholder="Establishment" name="establishment">
                                              ...
                                              <select class="form-control" name="affiliated_by">
                                                  ...
                                                  if(!empty($approvalList)){
                                                      foreach($approvalList as $approval){ ?>
                                                          <option value="<?= $approval['id']; ?>"><?= $approval['approval']; ?></option>
                                                      <?php } } ?>
                                              </select>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" placeholder="Contact Number 1" name="contact_one">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" placeholder="Contact Number 2" name="contact_two">
                                          </div>
                                      </div>
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              <label for="basiInput" class="form-label">Contact Number 3</label>
                                              <input type="text" class="form-control" placeholder="Contact Number 3" name="contact_three">
                                          </div>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" placeholder="Nodal Officer Name" name="nodal_officer_name">
                                          </div>
                                      </div>
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              <label for="basiInput" class="form-label">Nodal Officer Number</label>
                                              <input type="text" class="form-control" placeholder="Nodal Officer Number" name="nodal_officer_no">
                                          </div>
                                      </div>
                                  </div>
                                  <div class="row">
                                      ...
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" placeholder="Tags" name="keywords">
                                          </div>
                                      </div>
                                  </div>
                                  <div class="row">
