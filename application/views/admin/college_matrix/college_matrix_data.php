        ...
        if($collegeList){
            foreach($collegeList as $college) { ?>
                <tr>
                    ...
                    ?>
                        <td><input type="hidden" name="branch_id[]" class="form-control branch_id" value="<?= $branch['id']; ?>"><input type="text" placeholder="Seat" name="seat[]" class="form-control" value="<?= $SeatMatrixData['seats']; ?>"></th>
                    <?php } } ?>
