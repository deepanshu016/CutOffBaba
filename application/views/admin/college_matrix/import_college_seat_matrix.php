                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Import College Seats</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="card-title mb-0">Import College Seats</h4>
                        ...
                        <div class="card-body">
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    <form action="<?= base_url('admin/import-college-seat-matrix-data') ?>" method="POST" enctype="multipart/form-data" class="all-form">
