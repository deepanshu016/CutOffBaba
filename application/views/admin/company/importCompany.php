           ...
           <div class="col-lg-12">
              <div class="card">
                 <div class="card-header d-flex justify-content-between">
                      <h4 class="card-title mb-0">Import Company</h4>
                 </div>
                 <!-- end card header -->
                 <div class="card-body">
                    <div id="customerList">
                       <div class="row g-4 mb-3">
                          <div class="col-sm-auto">
                             <div>
                                ...
                                <a href="<?= base_url('assets/uploads/companyImport.xlsx'); ?>" class="btn btn-success add-btn" download="download"> View Sample</a>
                             </div>
                          </div>
                            <form action="<?= base_url('admin/import-company-by-excel') ?>" method="POST" enctype="multipart/form-data" class="all-form">
