                          ...
                          <table class="table align-middle table-nowrap" id="customerTable">
                             <thead class="table-light">
                                <tr>
                                   ...
                                   <th class="sort" data-sort="phone">Icon</th>
                             ...
                             <tbody class="list form-check-all">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img src="<?= base_url('assets/uploads/category'.'/'.$category['icon']) ?>" height="100" width="100" class="rounded-circle"></td>
                                        ...
                                        <td>
                                           <div class="hstack gap-3 flex-wrap">
                                              <a href="<?= base_url('admin/edit-category'.'/'.$category['id'].'/'.$category['slug']) ?>" class="link-success fs-15"><i class="ri-edit-box-line"></i></a>
