                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Import Category</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-body">
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    ...
                                    <ul style="color:red;margin-left: 15px;">
                                        ...
                                        <li>'category_name' field is required while uploading category dta </li>
                                        <li>head_id,visibility_id  required dynamic IDs</li>
                                    </ul>
                                    <form action="<?= base_url('admin/import-category-by-excel') ?>" method="POST" enctype="multipart/form-data" class="all-form">
