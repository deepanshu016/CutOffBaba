                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <?php if(empty($singleGallery)) { ?>
                              <li class="breadcrumb-item active">Add Video Gallery</li>
                            <?php } else{  ?>
           ...
           <div class="col-lg-12">
              <div class="card">
                 <div class="card-header">
                    <?php if(empty($singleGallery)) { ?>
                      <h4 class="card-title mb-0">Add Video Gallery</h4>
                    <?php } else{  ?>
                      <h4 class="card-title mb-0">Edit Video Gallery</h4>
                    <?php } ?>
                 </div>
                 <!-- end card header -->
                 <div class="card-body">
                    <div id="customerList">
                       <div class="row g-4 mb-3">
                          <div class="col-sm-auto">
                             <div>
                                <a href="<?= base_url('admin/video-gallery'); ?>" class="btn btn-success add-btn" > List</a>
                             </div>
                          </div>
                          <?php if(empty($singleGallery)) { ?>
                            <form action="<?= base_url('admin/save-video-gallery') ?>" method="POST" enctype="multipart/form-data" class="all-form">
                          <?php } else{  ?>
                            <form action="<?= base_url('admin/update-video-gallery') ?>" method="POST" enctype="multipart/form-data" class="all-form">
                          <?php } ?>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                       <div class="form-group">
                                          ...
                                          <?php if(!empty($singleGallery)) {  ?>
                                          <img src="<?= base_url('assets/uploads/video_gallery/thumbnail'.'/'.$singleGallery['thumbnail']) ?>" height="100" width="100" class="rounded-circle">
                                         <?php } ?>
