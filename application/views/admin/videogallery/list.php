           ...
           <div class="col-lg-12">
              <div class="card">
                 <div class="card-header">
                    <h4 class="card-title mb-0">Video Gallery List</h4>
                 </div>
                 <!-- end card header -->
                 <div class="card-body">
                    <div id="customerList">
                       <div class="row g-4 mb-3">
                          <div class="col-sm-auto">
                             <div>
                                <a href="<?= base_url('admin/add-video-gallery'); ?>" class="btn btn-success add-btn" ><i class="ri-add-line align-bottom me-1"></i> Add</a>
                             </div>
                          </div>
                       </div>
                             ...
                             <tbody class="list form-check-all">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php if(file_exists(FCPATH.'assets/uploads/video_gallery/thumbnail'.'/'.$gallery['thumbnail'])){ ?>
                                          <td class="banner_image"><img src="<?= base_url('assets/uploads/video_gallery/thumbnail'.'/'.$gallery['thumbnail']) ?>" height="100" width="100" class="rounded-circle"></td>
                                        <?php } else{ ?>
                                        ...
                                        <td class="action">
                                           <div class="hstack gap-3 flex-wrap">
                                              <a href="<?= base_url('admin/edit-video-gallery'.'/'.$gallery['id'].'/'.$gallery['slug']) ?>" class="link-success fs-15"><i class="ri-edit-box-line"></i></a>
                                              <a href="javascript:void(0);" class="link-danger fs-15 delete-data" data-id="<?= $gallery['id']; ?>" url="<?= base_url('admin/delete-video-gallery'); ?>"><i class="ri-delete-bin-6-fill"></i></a>
                                           </div>
                                        </td>
                                    </tr>
                                <?php } } ?>
