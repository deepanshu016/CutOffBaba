                ...
                if(isset($_FILES['excel_file']['name']) && in_array($_FILES['excel_file']['type'], $file_mimes)) {
                    ...
                    if(!empty($sheetData)){
                        foreach($sheetData as $key=>$sheet){
                            $excelDatas[$key]['nature'] = $sheet['nature'];
                        }
                    }
                    $stateId = $this->master->insertBulk('tbl_nature',$excelDatas);
                    $response = array('status' => 'success','message' => 'Nature status imported successfully','url'=>base_url('admin/nature'));
                    echo json_encode($response);
                    return true;
                }
            }
