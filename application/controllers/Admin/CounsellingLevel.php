                ...
                if(isset($_FILES['excel_file']['name']) && in_array($_FILES['excel_file']['type'], $file_mimes)) {
                    ...
                    if(!empty($sheetData)){
                        foreach($sheetData as $key=>$sheet){
                            $excelDatas[$key]['level'] = $sheet['level'];
                        }
                    }
                    $stateId = $this->master->insertBulk('tbl_counselling_level',$excelDatas);
                    $response = array('status' => 'success','message' => 'Counselling Level data  imported successfully','url'=>base_url('admin/counselling-level'));
                    echo json_encode($response);
                    return true;
                }
            }
