                ...
                if(isset($_FILES['excel_file']['name']) && in_array($_FILES['excel_file']['type'], $file_mimes)) {
                    ...
                    if(!empty($sheetData)){
                        foreach($sheetData as $key=>$sheet){
                            $stateData[$key]['name'] = $sheet['name'];
                            $stateData[$key]['country_id'] = $sheet['country_id'];
                        }
                    }
                    $stateId = $this->master->insertBulk('tbl_state',$stateData);
                    $response = array('status' => 'success','message' => 'State imported successfully','url'=>base_url('admin/country'));
                    echo json_encode($response);
                    return true;
                }
            }
