                ...
                if(isset($_FILES['excel_file']['name']) && in_array($_FILES['excel_file']['type'], $file_mimes)) {
                    ...
                    if(!empty($sheetData)){
                        foreach($sheetData as $key=>$sheet){
                            $excelDatas[$key]['degreetype'] = $sheet['degree_type'];
                        }
                    }
                    $stateId = $this->master->insertBulk('tbl_degree_type',$excelDatas);
                    $response = array('status' => 'success','message' => 'Degree Type status imported successfully','url'=>base_url('admin/degreetype'));
                    echo json_encode($response);
                    return true;
                }
            }
