            ...
            if($ext[1] === 'csv'){
                if(($handle = fopen($tmpName, 'r')) !== FALSE) {
                    ...
                    while(($data = fgetcsv($handle, 1000, ',')) !== FALSE) {
                        ...
                        if ($row>0) {
                            $impdata['country']=$data[1];
                            $impdata['state']=$data[2];
                            $impdata['district']=$data[3];
                            $impdata['sub_district']=$data[4];
                            $id=$data[0];
                            if($id==""){
                                $this->db->insert('tbl_sub_district',$impdata);
                            }else{
                                $this->db->where('id',$id)->update('tbl_sub_district',$impdata);
                            }
                        }
                        $row++;
                     }
