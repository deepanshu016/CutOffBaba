                ...
                if(isset($_FILES['excel_file']['name']) && in_array($_FILES['excel_file']['type'], $file_mimes)) {
                    ...
                    if(!empty($sheetData)){
                        foreach($sheetData as $key=>$sheet){
                            $excelDatas[$key]['sub_special_category_name'] = $sheet['sub_special_category_name'];
                            $excelDatas[$key]['slug'] = $this->slug($sheet['sub_special_category_name']);
                            $excelDatas[$key]['special_id'] = $sheet['special_id'];
                            $excelDatas[$key]['head_id'] = $sheet['head_id'];
                            $excelDatas[$key]['short_name'] = $sheet['short_name'];
                            $excelDatas[$key]['open_id'] = $sheet['open_id'];
                        }
                    }
                    $stateId = $this->master->insertBulk('tbl_sub_special_category',$excelDatas);
                    $response = array('status' => 'success','message' => 'Special Sub Category data  imported successfully','url'=>base_url('admin/sub-special-category'));
                    echo json_encode($response);
                    return true;
                }
            }
