         ...
         <section >
            <div class="collgeTx">
               <div class="container">
                     ...
                     <div class="col-12 ">
                        <div class="lc-block bgfosb">
                           <div class="d-flex px-1">
                              <div>
                                 <img class="sf9js" src="img/logocollege.png" alt="">
                              </div>
                              <div class="lc-block ps-2">
                                 <div editable="rich">
                                    <h3 class="h6 "><strong>Patna Medical College(PMCH)</strong><br></h3>
                                    <img class="bsnXs" src="img/locations.png" alt=""> <span class="loPts">Patna, Bihar, India</span>  
                                    <img class="bsnXs" src="img/emailsss.png" alt=""> <span class="loPts"> pmch@gmail.com </span> <br>  <img class="bsnXs" src="img/website.png" alt=""> <span class="loPts"> patnamedicalcollege.edu.in </span>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="row">
                     <div class="col-12">
                        <div class="maiPoint"> <img src="img/sign1.png" alt=""> <span class="apnsFonts">Alternate Name1</span>
                           <img src="img/sign1.png" alt=""> <span class="apnsFonts">Alternate</span>
                           <img src="img/estd.png" alt=""> <span class="apnsFonts">Estd.1995</span>
                           <img src="img/patsh.png" alt=""> <span class="apnsFonts">AKU, Patna</span>
                           <img src="img/mci.png" alt=""> <span class="apnsFonts">MCI Approved</span>
                           <img src="img/yess.png" alt=""> <span class="apnsFonts">Yes</span>
                           <img src="img/mals.png" alt=""> <span class="apnsFonts">Male/Female</span>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="tab-content tsyTops" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade " id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                           <div class="input-group mb-3">
                              <span class="input-group-text appendCXCss raformsss" id="basic-addon1"> <img class="img-fluid useHsih" src="img/colls.png" alt=""> </span>
                              <select class="form-control raformsss"  name="" id="">
                                 <option value="">Select College</option>
                              </select>
                           </div>
                           <div class="input-group mb-3">
                              <span class="input-group-text appendCXCss raformsss" id="basic-addon1"> <img class="img-fluid useHsih" src="img/coou.png" alt=""> </span>
                              <select class="form-control raformsss"  name="" id="">
                              ...
                              <div class="row ">
                                 <div class="col col-md-2">
                                    <div class="CustoScollShet" >
                                       <img src="img/bedllust.png" class="card-img-top resPis" alt="..."> 
                                    </div>
                                    <div class="besdTxt">
                                 ...
                                 <div class="col col-md-2 ">
                                    <div class="CustoScollShet" >
                                       <img src="img/inpatientillust.png" class="card-img-top resPis" alt="..."> 
                                    </div>
                                    <div class="besdTxt">
                                 ...
                                 <div class="col col-md-2">
                                    <div class="CustoScollShet" >
                                       <img src="img/papap.png" class="card-img-top resPis" alt="..."> 
                                    </div>
                                    <div class="besdTxt">
                                       <h5 class="card-title toptaTx">Out Patient</h5>
                                    </div>
                                 ...
                                 <div class="col col-md-2">
                                    <div class="CustoScollShet" >
                                       <img src="img/Breastfeeding.png" class="card-img-top resPis" alt="..."> 
                                    </div>
                                    <div class="besdTxt">
                                       <h5 class="card-title toptaTx">Out Patient</h5>
                                    </div>
                                 ...
                                 <div class="col col-md-2">
                                    <div class="CustoScollShet" >
                                       <img src="img/deathllust.png" class="card-img-top resPis" alt="..."> 
                                    </div>
                                    <div class="besdTxt">
                                 ...
                                 <div class="col col-md-2">
                                    <div class="CustoScollShet" >
                                       <img src="img/BORillust.png" class="card-img-top resPis" alt="..."> 
                                    </div>
                                    <div class="besdTxt">
                     ...
                     <div class="photo-gallery">
                        <div class="container">
                              ...
                              <div class="row photos">
                                 <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/coll1.png" data-lightbox="photos"><img class="img-fluid" src="img/coll1.png"></a></div>
                                 <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/coll2.png" data-lightbox="photos"><img class="img-fluid" src="img/coll2.png"></a></div>
                              </div>
                              <div class="row photos">
                                 <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/coll3.png" data-lightbox="photos"><img class="img-fluid" src="img/coll3.png"></a></div>
                                 <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/coll4.png" data-lightbox="photos"><img class="img-fluid" src="img/coll4.png"></a></div>
                              </div>
                        </div>
                     </div> 
                     ...
                     <div class="photo-gallery">
                        <div class="container">
                              ...
                              <div class="row photos">
                                 <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/coll5.png" data-lightbox="photos"><img class="img-fluid" src="img/coll5.png"></a></div>
                                 <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/coll6.png" data-lightbox="photos"><img class="img-fluid" src="img/coll6.png"></a></div>
                              </div>
                              <div class="row photos">
                                 <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/coll7.png" data-lightbox="photos"><img class="img-fluid" src="img/coll7.png"></a></div>
                                 <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/uiis.png" data-lightbox="photos"><img class="img-fluid" src="img/uiis.png"></a></div>
                              </div>
                        </div>
                     </div> 
                     ...
                     <h5 class="clinkTxt">College Events</h5>
                        ...
                        <div class="photo-gallery">
                           <div class="container">
                                 ...
                                 <div class="row photos">
                                    <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/evt1.png" data-lightbox="photos"><img class="img-fluid" src="img/evt1.png"></a></div>
                                    <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/evt2.png" data-lightbox="photos"><img class="img-fluid" src="img/evt2.png"></a></div>
                                 </div>
                                 <div class="row photos">
                                    <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/evt3.png" data-lightbox="photos"><img class="img-fluid" src="img/evt3.png"></a></div>
                                    <div class="col-sm-6 col-md-4 col-lg-3 col item"><a href="img/evt4.png" data-lightbox="photos"><img class="img-fluid" src="img/evt4.png"></a></div>
                                 </div>
                           </div>
                        </div> 
                        ...
                        <li class="list-group-item"> <img src="img/mamps.png" alt=""> Ashok Rajpath, Patna University Campus,Patna, Bihar, India - 800001</li>
                        <li class="list-group-item"> <img src="img/Phone.png" alt=""> Admission Cell - 0612-2300343</li>
                        <li class="list-group-item"> <img src="img/Phone.png" alt=""> Enquiry Cell - 0612-284443</li>
