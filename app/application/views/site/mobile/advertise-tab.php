         ...
         <div class="position-relative overflow-hidden   p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 p-3 mx-auto ">
               ...
               <div class="card radius">
                  <img src="img/advs.png" class="card-img cuysss " alt="doc-pic">
                  <div class="card-img-overlay mbbsOverlay">
                     <h5 class="card-title">Lorem Ipsum Dolor Sit.</h5>
                     <p class="card-text txcfs">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo con</p>
                    <a class="linsc" href="#!">Link</a>
                    </div>
               </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>We are the India’s most innovative and interactive education portal with an ergonomically designed interface which ensures the maximum conversion. Collegedunia.</p>
                            <h5>What we offer?</h5>
                            <div class="row">
                                <div class="col-8">
                                    <h5>We are the India’s most. </h5>
                                    <p>nnovative and interactive education portal with an</p>
                                    <h5>ergonomically designed.</h5>
                                    <p>which ensures the maximum conversion</p>
                                    <h6>Mail Us : info@cutoffbaba.com</h6>
                                </div>
                                <div class="col-4">
                                    <img class="img-fluid" src="img/d2w.png" alt="">
                                     
                                    <img class="img-fluid fcsxz" src="img/d2w.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
