...
$route['admin/update-cutoff-head-rank'] = 'Admin/CounsellingHead/updateCounsellingRank';
...
$route['admin/get-branchess'] = 'Admin/CollegeMatrix/getBranches';
...
$route['admin/get-course'] = 'Admin/Common/getCourseByStream';
